...
# CHANGED: Updated extension from .h5 to .keras
...
def get_transformer_move(board_state):
    ...
    # 1️⃣ Convert to numpy (float32 to match training)
    ...
    # 2️⃣ Build EXACT same 2-channel format used during training
    ...
    # 3️⃣ Reshape EXACTLY like training
